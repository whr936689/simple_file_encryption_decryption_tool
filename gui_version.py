...
btn1.pack(pady=10)
# 创建单选按钮
grid_frame=ctk.CTkFrame(root,fg_color="#babce0")
grid_frame.pack(pady=10)
radio_button1 = ctk.CTkRadioButton(grid_frame, text="加密",font=("UniSun",20),fg_color="#4d5880",hover_color="#3d4566",border_color="#5a6794", variable=radio_var, value="3").grid(row=0, column=0)
radio_button2 = ctk.CTkRadioButton(grid_frame, text="解密",font=("UniSun",20),fg_color="#4d5880",hover_color="#3d4566",border_color="#5a6794", variable=radio_var, value="4").grid(row=0, column=1)
#radio_button1.pack()
#radio_button2.pack()
